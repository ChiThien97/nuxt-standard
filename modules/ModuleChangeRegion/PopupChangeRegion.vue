<template>
  <div class="mb-1">
    <b-dropdown id="dropdown-region" no-caret variant="link">
      <template #button-content>
        <div class="box-local-store">
          ...
          <div class="box-content">
            ...
            <p><span>{{ "Miền Nam" }}</span>&ensp;<font-awesome-icon
              icon="chevron-down"/>
            </p>
          </div>
        </div>
      </template>
      <b-dropdown-item>Miền Nam</b-dropdown-item>
      <b-dropdown-divider></b-dropdown-divider>
      <b-dropdown-item>Miền Bắc</b-dropdown-item>
    </b-dropdown>
  </div>
</template>
